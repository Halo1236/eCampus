...
import com.halo.campus.apprtc.util.AsyncHttpURLConnection;
...
public class RoomParametersFetcher {
    ...
    private void roomHttpResponseParse(String response) {
        ...
        try {
            ...
            //iceServers.add(new PeerConnection.IceServer("blueslug.cc"));
...
//        List<PeerConnection.IceServer> turnServers =
//                requestTurnServers("http://blueslug.cc");
    ...
    private List<PeerConnection.IceServer> requestTurnServers(String url)
        ...
        //connection.setRequestProperty("REFERER", "192.168.2.246:8080");
