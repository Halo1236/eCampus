...
import com.halo.campus.apprtc.util.UnhandledExceptionHandler;
...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
    ...
    @Override
    public void onTelSwitch() {
        if (peerConnectionClient != null) {
            speakerEnabled = !speakerEnabled;
            peerConnectionClient.setVideoEnabled(speakerEnabled);
        }
    }
