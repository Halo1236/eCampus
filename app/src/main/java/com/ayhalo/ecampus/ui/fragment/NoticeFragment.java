...
public class NoticeFragment extends BaseFragment implements HttpListener<String>, OnItemClickListener, OnRefreshLoadMoreListener {
    ...
    private void getData(int page) {
        String url = Global.HOST + "api/topic/data/20/" + page + "/1/json";
